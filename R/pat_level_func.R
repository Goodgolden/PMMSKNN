...
# LOOCV Function ----
# - - - - - - - - - - - - - - - - - - - -#
pat_level_func <- function(ref = ref, nearest,
  ...
  if (!is.null(parallel)) {
    ...
    loocvres <- foreach(
      n = nearest,
      .export = c(
        "ord_data", "train_post", "test_post", "spl", "ptr_m", "d_f_m", "d_f_s",
        ...
        "loocv", "mint", "maxt", "traintestmatchdf", "m"
