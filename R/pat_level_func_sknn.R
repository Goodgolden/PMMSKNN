...
# LOOCV Function ----
# - - - - - - - - - - - - - - - - - - - -#
pat_level_func_sknn <- function(nearest,
                                loocv = loocv,
                                parallel = parallel,
  ...
  if (!is.null(parallel)) {
    ...
    loocvres <- foreach(
      n = nearest,
      .export = c(
        "train_post", "test_post", "spl", "ptr_m", "d_f_m", "d_f_s", "train", "test", "gamlss_dist",
        ...
        "loocv", "mint", "maxt", "traintestmatchdf"
